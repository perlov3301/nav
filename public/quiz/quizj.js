...
*/
 ...
 $('#ab081,#ab086,#ab0861').on('click',function()
     {
       $('#ad088').hide();
       var a1='';
       var ai1=0;//'0'
      ...
      if(ai1>0)
       {
        if(ai1==1)
         {
          $('#ad089,#ad002').html('there is a question without response:'+a1)
        ;}
         else
          {
           $('#ad089,#ad002').html('the questions without response:'+a1)
         ;};      
      ;}//if>0
       else
        {
  ...
  $('#ab086,#ab0861').on('click',function()
     {
       var i1=0;
      $('#ad087').html('');
      $('#ad089').html('');
